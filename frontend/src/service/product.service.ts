...
export class ProductService {
  ...
  public getNewProducts(): Observable<ProductShort[]> {
    return this.http.get<ProductShort[]>('/api/newProducts').pipe(
  ...
  public getProduct(id: number): Promise<ProductDetail> {
    return this.http.get<ProductDetail>('/api/productDetail?productId=' + id).toPromise();
  }

  public getProductShort(id: number): Promise<ProductShort> {
    return this.http.get<ProductShort>('/api/productShort?productId=' + id).toPromise();
  }
  ...
  public getProductMock(id: number): ProductDetail {
    const product = new ProductDetail(1,
      'DELL SE2419H',
      4294000,
      20,
      'dell',
  ...
  public getProductShortMock(id: number): ProductShort {
    return new ProductShort(1, "DELL 12312Bsd", 7000000, 24, "Dell", "base64/..", "Màn Hình Máy Tính Dell (DELL) SE2419H (23.8 inch)");
  }
